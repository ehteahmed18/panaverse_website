...
import { Box,Text,Flex,Heading,Stack,Button,StackProps,useBreakpointValue} from "@chakra-ui/react";
...
export default function Course(){
    return(
        ...
        <Box>
        <Flex alignItems={useBreakpointValue({base:"center",md:"center"})} direction={useBreakpointValue({base:"column",sm:"column",md:"row"})}>
                <Stack >
                    ...
                    mt={useBreakpointValue({base:"10px",sm:"15px",md:"40px"})} textAlign="center" >
                ...
                <Stack >
                    ...
                    mt={["10px","20px","50px"]} textAlign="center">
