    ...
    return(
        ...
        <Flex flexWrap={"wrap"} justifyContent={"center"}  >
            ...
            <Flex justifyContent={"center"}  direction={useBreakpointValue({base:"column",sm:"column",md:"column",lg:"row"})}> */}
                <HStack m={useBreakpointValue({base:"10px",sm:"15px",md:"20px"})} justifyContent="center">
                    <Box className={styles.box} width={useBreakpointValue({base:"300px",sm:"300px",md:"300px",lg:"300px",xl:"350px"})} height={useBreakpointValue({base:"520px",md:"550px",lg:"580px",xl:"530px"})}  bg={"lightgray"} p={"30px"} borderRadius={"3xl"} boxShadow={'0px 20px 25px -5px rgba(0, 0, 0, 0.1), 0px 10px 10px -5px rgba(0, 0, 0, 0.04)'}
                     textAlign="center"> 
                ...
                <HStack m={useBreakpointValue({base:"10px",sm:"15px",md:"20px"})} justifyContent="center">
                    <Box className={styles.box} width={useBreakpointValue({base:"300px",sm:"300px",md:"300px",lg:"300px",xl:"350px"})} height={useBreakpointValue({base:"550px",md:"550px",lg:"580px",xl:"530px"})}  bg={"lightgray"} p={"30px"} borderRadius={"3xl"} boxShadow={'0px 20px 25px -5px rgba(0, 0, 0, 0.1), 0px 10px 10px -5px rgba(0, 0, 0, 0.04)'}
                         textAlign="center">
                ...
                <HStack m={useBreakpointValue({base:"10px",sm:"15px",md:"20px"})} justifyContent="center">
                    <Box className={styles.box} width={useBreakpointValue({base:"300px",sm:"300px",md:"300px",lg:"300px",xl:"350px"})} height={useBreakpointValue({base:"600px",md:"550px",lg:"580px",xl:"530px"})} bg={"lightgray"} p={"30px"} borderRadius={"3xl"} boxShadow={'0px 20px 25px -5px rgba(0, 0, 0, 0.1), 0px 10px 10px -5px rgba(0, 0, 0, 0.04)'}
                     textAlign="center" > 
