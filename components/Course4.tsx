    ...
    return (
        <>
            ...
            <Box as="section" mt={"10px"} pt={"200px"}bg={"gray.200"}> </Box>
                ...
                <Quarter/>
                    <Box className={styles.box}  as="section" mt={["10px","20px","50px"]}mx={["10px","20px","50px"]}bg={"lightgrey"} maxW={"full"} height={["650px","220px"]} borderRadius={"2xl"}>
