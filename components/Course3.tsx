    ...
    return (
        <>
            ...
            <Box as="section" mt={"10px"} pt={"200px"}bg={"gray.200"}> </Box>
               ...
               <Quarter/>
                    <Box className={styles.box}  as="section" mt={["10px","20px","50px"]}mx={["10px","20px","50px"]}bg={"lightgrey"} maxW={"full"} height={["490px","180px"]} borderRadius={"2xl"}>
                    ...
                    <Box className={styles.box}  as="section" mt={["10px","20px","50px"]}mx={["10px","20px","50px"]} mb={"10px"}bg={"lightgrey"} maxW={"full"} height={["530px","200px"]} borderRadius={"2xl"}>
